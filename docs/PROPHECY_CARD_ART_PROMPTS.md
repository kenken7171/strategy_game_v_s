...
| アスペクト | **横長バナー 16:9 推奨**（カードの絵placeは 220×124≒16:9）。**1024×576** 程度で生成→そのまま |
| 構図 | **中央に象徴アイコン1つ**を大きく・小さく(220px)でも一目で分かる・読みやすい・端は寄せ過ぎない |
...
soft glow, shallow depth of field, cohesive game art, 16:9 horizontal banner, no text, no letters, no border
```

### 共通スタイル（日本語・対訳）
```
中央に1つの象徴アイコン、ファンタジーのタロット/予兆カード風イラスト、厚塗り、読みやすい明快な形、
柔らかな発光、浅い被写界深度、統一感のあるゲームアート、16:9 横長バナー、文字なし、枠なし
```
...
- カード上部の絵 place は **220×124≒16:9**。16:9 で作れば letterbox の黒帯が出ない。
